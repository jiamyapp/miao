...
.search_body .search_input_wrapper{ padding: 0 10px; border: 1px solid #e6e6e6; border-radius: 5px; background-color: #fff; display: flex; line-height: 30px;}
.search_body .search_input_wrapper i{font-size: 20px; padding: 4px 0;}
.search_body .search_input_wrapper input{ border: none; font-size: 16px; color: #333; padding: 4px 0; outline: none; margin-left: 5px; width:100%;}
