  ...
  <div id="main">
    ...
    <div id="content">
      <div class="movie_menu">
        <router-link tag="div" to="/dianying/city" class="city_name">
          <span>大连</span><i class="iconfont icon-lower-triangle"></i>
        </router-link>
        <div class="hot_swtich">
          <router-link tag="div" to="/dianying/hot" class="hot_item">正在热映</router-link>
          <router-link tag="div" to="/dianying/jijiang" class="hot_item">即将上映</router-link>
        </div>
        <router-link tag="div" to="/dianying/sousuo" class="search_entry">
